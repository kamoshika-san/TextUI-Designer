...
/**
 * sample/10-new-built-in-stub が schema + export で壊れないことの最小回帰（E2-S2-T3）。
 * スタブ文言を変えたら、この期待文字列も合わせること。
 */
describe('sample 10-new-built-in-stub', () => {
  it('new-built-in-stub.tui.yml が HtmlExporter で出力できる', async () => {
    const ymlPath = path.join(__dirname, '..', '..', 'sample', '10-new-built-in-stub', 'new-built-in-stub.tui.yml');
