...
|---|---|---|
| Route inventory | Primary / Fallback entry points are listed in one place | `docs/html-exporter-primary-fallback-inventory.md` |
...
| Primary-first guidance | maintainer and built-in authoring docs treat Primary as source of truth | `docs/exporter-boundary-guide.md`, `docs/adding-built-in-component.md`, `docs/MAINTAINER_GUIDE.md` |
