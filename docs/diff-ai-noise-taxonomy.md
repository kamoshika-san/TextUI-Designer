...
- alias collapse from `docs/diff-alias-type-nesting-rules.md`
...
- type normalization from `docs/diff-alias-type-nesting-rules.md`
...
- shorthand expansion and nesting normalization from `docs/diff-alias-type-nesting-rules.md`
...
- scope boundary and nesting guardrails from `docs/diff-normalization-scope-boundary.md`
...
- default expansion and pruning from `docs/diff-default-expansion-pruning-rules.md`
...
This taxonomy complements `docs/diff-normalization-golden-cases.md`.
