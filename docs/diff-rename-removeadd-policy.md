...
- `docs/diff-ir-identity-policy.md` remains the authority for baseline continuity
- `docs/diff-reorder-move-policy.md` handles structural relocation and should not be reinterpreted here
