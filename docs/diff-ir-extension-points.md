...
- this page extends the minimal vocabulary from `docs/diff-ir-vocabulary.md` without replacing it
- this page stays consistent with the extraction boundary in `docs/diff-ir-extraction-contract.md`
- this page does not weaken the identity rules already fixed in `docs/diff-ir-identity-policy.md`
