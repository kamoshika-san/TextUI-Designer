...
| [`webview-semantic-diff-v2-panel-spec.md`](webview-semantic-diff-v2-panel-spec.md) | Diff Panel（WebView）semantic v2 対応 — Wave 0（postMessage・タブ IA・P1 残論点） |
...
- v2 証拠レジストリ（`evidence_shape`）: `docs/current/dsl-ssot-types/v2-evidence-shapes-registry-ja.md`
- JSON Schema: `docs/future/schemas/v2/evidence/`
- コード寄り record 型: `docs/future/types/v2/diff-record.ts`

## 旧パス

- `docs/archive/semantic-meaning-core-ontology-v0-ja.md` にスタブを残し、本フォルダへ誘導している。
