...
If you need implementation boundaries or maintainer-oriented notes after onboarding, continue with `docs/current/runtime-boundaries/cli-boundary-guide.md`.
