...
The contributor lane covering setup, branch flow, pull requests, and daily commands. Current canonical destinations are `README.md`, `CONTRIBUTING.md`, and `docs/current/workflow-onboarding/SETUP.md`.
