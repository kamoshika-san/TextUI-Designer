...
| Development Workflow | `CONTRIBUTING.md`, `docs/current/workflow-onboarding/SETUP.md`, built-in component workflow docs | `Maintainer` | per change | setup, workflow, or contributor-process changes |
...
| Testing / Quality Gates | `docs/current/workflow-onboarding/TESTING.md`, CI gate docs, guard matrices, smoke docs | `Reviewer` | per change | test lane, gate, or release-check changes |
...
- `docs/current/workflow-onboarding/TESTING.md`, `docs/current/testing-ci/ci-quality-gate.md`, and related gate docs under the `Reviewer` lane
