...
3. `src/services/service-runtime-phases.ts`
   - 起動時ランタイム処理の段階化
4. `docs/current/operations/MAINTAINER_GUIDE.md`
   - 保守運用全体の規約
...
- runtime inspection 境界: `docs/current/runtime-boundaries/runtime-inspection-boundary.md`
- 互換ポリシー: `docs/current/workflow-onboarding/api-compat-policy.md`
