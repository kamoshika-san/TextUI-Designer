...
| **非 React exporter** | `pug/*` and format-specific string builders | 文字列生成系。Preview diff / component-map との共有ユーティリティに注意。`legacy/html-renderers/*` は `T-20260422-014` で削除済み。 |
...
- [preview-export-shell-contract.md](preview-export-shell-contract.md)
