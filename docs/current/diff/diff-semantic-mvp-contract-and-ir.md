...
- `docs/current/diff/diff-ir-spec-and-guide.md`
- `docs/current/diff/diff-ir-identity-policy.md`
- `docs/current/diff/diff-summary-event-vocabulary.md`
- `docs/current/diff/diff-summary-payload-schema.md`
- `docs/current/diff/diff-sourcref-jump-and-evidence-navigation.md`
