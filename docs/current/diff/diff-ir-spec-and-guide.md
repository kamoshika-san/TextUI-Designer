...
- `docs/current/diff/diff-ir-vocabulary.md`
- `docs/current/diff/diff-ir-extraction-contract.md`
- `docs/current/diff/diff-ir-identity-policy.md`
- `docs/current/diff/diff-reorder-move-policy.md`
- `docs/current/diff/diff-rename-removeadd-policy.md`
- `docs/current/diff/diff-similarity-matching-boundary.md`
- `docs/current/diff/diff-ir-extension-points.md`
...
`docs/current/diff/diff-ir-vocabulary.md` defines the comparison units:
...
`docs/current/diff/diff-ir-extraction-contract.md` defines how parsed DSL becomes comparison-ready IR.
...
`docs/current/diff/diff-ir-identity-policy.md` defines primary and deterministic fallback identity.
...
`docs/current/diff/diff-similarity-matching-boundary.md` defines bounded heuristic rescue.
...
`docs/current/diff/diff-ir-extension-points.md` defines reserved hooks for future richer comparison work.
...
1. read `docs/current/diff/diff-ir-vocabulary.md`
2. read `docs/current/diff/diff-ir-extraction-contract.md`
3. read `docs/current/diff/diff-ir-identity-policy.md`
4. read `docs/current/diff/diff-reorder-move-policy.md`
5. read `docs/current/diff/diff-rename-removeadd-policy.md`
6. read `docs/current/diff/diff-similarity-matching-boundary.md`
7. read `docs/current/diff/diff-ir-extension-points.md`
