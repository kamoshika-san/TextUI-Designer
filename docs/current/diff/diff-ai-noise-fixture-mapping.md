...
- `docs/current/diff/diff-ai-noise-taxonomy.md` for bucket semantics
- `docs/current/diff/diff-normalization-fixture-shape.md` for the base fixture manifest
...
bucketRef:
  ...
  sourceDoc: docs/current/diff/diff-ai-noise-taxonomy.md
