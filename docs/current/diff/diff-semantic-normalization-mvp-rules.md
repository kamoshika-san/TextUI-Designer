...
- `docs/current/diff/diff-normalization-spec-and-guide.md`
...
- `docs/current/diff/diff-normalization-fixture-shape.md`
...
- `docs/current/diff/diff-semantic-mvp-contract-and-ir.md`
- `docs/current/diff/diff-normalization-spec-and-guide.md`
- `docs/current/diff/diff-canonical-order-rules.md`
- `docs/current/diff/diff-default-expansion-pruning-rules.md`
- `docs/current/diff/diff-normalization-golden-cases.md`
