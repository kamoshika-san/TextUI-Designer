...
- the rule-oriented baseline in `docs/current/diff/diff-normalization-golden-cases.md`
- the AI-noise bucket design in `docs/current/diff/diff-ai-noise-taxonomy.md`
...
caseRef:
  ...
  stage: stage-1
  sourceDoc: docs/current/diff/diff-normalization-golden-cases.md
