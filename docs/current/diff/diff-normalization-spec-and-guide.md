...
- `docs/current/diff/diff-normalization-scope-boundary.md`
- `docs/current/diff/diff-extraction-normalization-boundary.md`
- `docs/current/diff/diff-normalization-pipeline-stages.md`
- `docs/current/diff/diff-canonical-order-rules.md`
- `docs/current/diff/diff-default-expansion-pruning-rules.md`
- `docs/current/diff/diff-alias-type-nesting-rules.md`
- `docs/current/diff/diff-normalization-golden-cases.md`
- `docs/current/diff/diff-ai-noise-taxonomy.md`
...
`docs/current/diff/diff-extraction-normalization-boundary.md` defines the handoff from extraction into normalization.
...
`docs/current/diff/diff-normalization-scope-boundary.md` defines what normalization may rewrite and what it must leave for structural diff or semantic layers.
...
`docs/current/diff/diff-normalization-pipeline-stages.md` defines the four-stage pipeline:
...
`docs/current/diff/diff-normalization-golden-cases.md` defines representative positive cases and negative controls.
...
`docs/current/diff/diff-ai-noise-taxonomy.md` sorts AI-authored drift into:
...
1. read `docs/current/diff/diff-extraction-normalization-boundary.md`
2. read `docs/current/diff/diff-normalization-scope-boundary.md`
3. read `docs/current/diff/diff-normalization-pipeline-stages.md`
4. read `docs/current/diff/diff-canonical-order-rules.md`
5. read `docs/current/diff/diff-default-expansion-pruning-rules.md`
6. read `docs/current/diff/diff-alias-type-nesting-rules.md`
7. read `docs/current/diff/diff-normalization-golden-cases.md`
8. read `docs/current/diff/diff-ai-noise-taxonomy.md`
