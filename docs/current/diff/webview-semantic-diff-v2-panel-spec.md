...
- **v2 型正本（参照のみ）**: `docs/future/types/v2/diff-record.ts`、`docs/future/types/v2/dsl-structure.ts`、設計 A〜H、`semantic-meaning-core-ontology-v0-ja.md`  
...
`docs/current/diff/webview-semantic-diff-v2-panel-spec.md`
