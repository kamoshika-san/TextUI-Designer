...
1. deterministic identity from `docs/current/diff/diff-ir-identity-policy.md`
2. deterministic reorder or move rules from `docs/current/diff/diff-reorder-move-policy.md`
3. deterministic rename or property-change rules from `docs/current/diff/diff-rename-removeadd-policy.md`
