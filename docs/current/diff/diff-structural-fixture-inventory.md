...
- `docs/current/diff/diff-acceptance-scenario-matrix.md` for accepted structural outcomes
- `docs/current/diff/diff-reorder-move-policy.md`, `docs/current/diff/diff-rename-removeadd-policy.md`, and `docs/current/diff/diff-similarity-matching-boundary.md` for rule boundaries
- `docs/current/diff/diff-normalization-fixture-shape.md` and `docs/current/diff/diff-ai-noise-fixture-mapping.md` for executable fixture vocabulary
...
- normalization-only baseline:
  ...
  - belongs to `docs/current/diff/diff-normalization-fixture-shape.md`
...
caseRef:
  ...
  ruleFamily: reorder
  sourceDocs:
    - docs/current/diff/diff-acceptance-scenario-matrix.md
