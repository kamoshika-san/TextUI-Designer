...
- `docs/diff-summary-event-vocabulary.md` for summary category semantics
...
This must use the settled values from `docs/diff-summary-event-vocabulary.md`, for example:
