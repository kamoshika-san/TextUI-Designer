...
export function validateDsl(dsl: unknown, sourcePath?: string): ValidationResult {
  ...
  issues.push(...validateSemanticRules(dsl, sourcePath));
...
function validateSemanticRules(dsl: unknown, sourcePath?: string): ValidationIssue[] {
  const issues: ValidationIssue[] = [];
