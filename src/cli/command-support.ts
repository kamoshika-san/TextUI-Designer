...
export function printHelp(): void {
  ...
  process.stdout.write('Capture: textui capture --file <path> [--output <png>] [--theme <path>] [--extension-path <dir>] [--width <px>] [--height <px>] [--scale <n>] [--wait-ms <ms>] [--browser <path|name>] [--allow-no-sandbox] [--json]\n');
