...
textui apply    [--file <path>|--dir <path>] [--state .textui/state.json] [--provider html|react|pug] [--auto-approve] [--json]
textui export   [--file <path>] [--provider html|react|pug] [--output <path>] [--deterministic] [--json]
